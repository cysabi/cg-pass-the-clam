...
const Host = () => {
  ...
  return (
    <div class="relative w-full max-w-2xl flex flex-col items-center pt-20 text-white">
      ...
      <div class="absolute bottom-0 -translate-y-32 translate-x-36 left-0 flex justify-between items-center bg-black border-4 gap-5 px-5 py-2 text-2xl text-[1.56rem] -skew-y-3 z-20">
        <div ref={hostRef}></div>
